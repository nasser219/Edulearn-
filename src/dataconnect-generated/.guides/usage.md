...
```ts
import { useAllCourses, useMyEnrollments, useCreateLesson, useUpdateUserBio } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useAllCourses();

const { data, isPending, isSuccess, isError, error } = useMyEnrollments();
...
```js
import { allCourses, myEnrollments, createLesson, updateUserBio } from '@dataconnect/generated';


// Operation AllCourses: 
